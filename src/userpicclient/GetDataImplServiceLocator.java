...
public class GetDataImplServiceLocator extends org.apache.axis.client.Service implements userpicclient.GetDataImplService {
    ...
    private java.lang.String GetDataImplPort_address = "http://10.1.13.28:7003/wxwebservice/cxf/UserInfoService";
    ...
    public userpicclient.IGetData getGetDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public userpicclient.IGetData getGetDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            userpicclient.GetDataImplServiceSoapBindingStub _stub = new userpicclient.GetDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (userpicclient.IGetData.class.isAssignableFrom(serviceEndpointInterface)) {
                userpicclient.GetDataImplServiceSoapBindingStub _stub = new userpicclient.GetDataImplServiceSoapBindingStub(new java.net.URL(GetDataImplPort_address), this);
                _stub.setPortName(getGetDataImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.userInfoquery.mdms.soft.com/", "GetDataImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.userInfoquery.mdms.soft.com/", "GetDataImplPort"));
        }
