...
public class RequestMessage  implements java.io.Serializable {
    private userpicclient.Message message;

    private java.lang.String noun;

    private userpicclient.User user;
    ...
    public RequestMessage(
           userpicclient.Message message,
           java.lang.String noun,
           userpicclient.User user,
     ...
     * @return message
     */
    public userpicclient.Message getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(userpicclient.Message message) {
        this.message = message;
    }
     ...
     * @return user
     */
    public userpicclient.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(userpicclient.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.userInfoquery.mdms.soft.com/", "requestMessage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("message");
        elemField.setXmlName(new javax.xml.namespace.QName("", "message"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.userInfoquery.mdms.soft.com/", "message"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.userInfoquery.mdms.soft.com/", "user"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
