...
public class ResponseMessage  implements java.io.Serializable {
    ...
    private userpicclient.ErrorMessage errorMessage;

    private userpicclient.Result[] result;
    ...
    public ResponseMessage(
           ...
           userpicclient.ErrorMessage errorMessage,
           userpicclient.Result[] result,
     ...
     * @return errorMessage
     */
    public userpicclient.ErrorMessage getErrorMessage() {
        return errorMessage;
    }
     ...
     * @param errorMessage
     */
    public void setErrorMessage(userpicclient.ErrorMessage errorMessage) {
        this.errorMessage = errorMessage;
    }
     ...
     * @return result
     */
    public userpicclient.Result[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(userpicclient.Result[] result) {
        this.result = result;
    }

    public userpicclient.Result getResult(int i) {
        return this.result[i];
    }

    public void setResult(int i, userpicclient.Result _value) {
